        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="page-title mb-0 font-size-18">User Posting</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">User Posting</h4>
                                            <form class="needs-validation" id="adduserform" novalidate>
                                                ...
                                                <button class="btn btn-primary" id="addfaq" name="adduser" type="submit">Update User Posting</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <div class="font-size-16 mt-2">User Posting</div>
                            </div>
                        </div><br>
                        <?php 
                        include('includes/dbcon.php');
